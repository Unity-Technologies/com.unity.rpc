...
namespace Unity.Ipc.Hosted.Extensions
{
    ...
    public static class HostExtensions
    {
        ...
        public static IIpcRegistration GetRegistration(this IServiceProvider serviceProvider) => serviceProvider.GetService<IIpcRegistration>();
