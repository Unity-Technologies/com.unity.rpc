...
namespace Shared
{
    ...
    public class IpcServerPerClientConnection : IIpcServerPerConnection
    {
        private readonly ILog logger = LogProvider.For<IpcServerPerClientConnection>();

        private readonly IpcServerSingleton globalServer;
        private readonly IRequestContext context;
        private IIpcJobProgress Client => context.GetRemoteTarget<IIpcJobProgress>();
        ...
        public IpcServerPerClientConnection(IpcServerSingleton globalServer, IRequestContext context)
        {
